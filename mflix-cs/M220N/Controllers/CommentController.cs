...
namespace M220N.Controllers
{
    public class CommentController : ControllerBase
    {
        ...
        /// <summary>
        /// Deletes an existing comment. Validates the user with JWT to ensure the user updating the
        /// comment is the original commentator.
        /// </summary>
        /// <param name="input">A JSON object in the body of the message.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Updates an existing comment. Validates the user with JWT to ensure the user updating the
        /// comment is the original commentator.
        /// </summary>
        /// <param name="input">A JSON object in the body of the message.</param>
        /// <returns></returns>
    ...
    /// <summary>
    /// Helper class to define the expected JSON object passed in the Request body.
    /// </summary>
