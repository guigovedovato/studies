...
{
    /// <summary>
    /// The mflix client app sends the password as a json object (not string) in the request body,
    /// like this: {"password": "foo"}. This class makes it easy to deserialize it.
    /// </summary>
    ...
    public class UserController : ControllerBase
    {
        ...
        /// <summary>
        /// IMPORTANT: this API is here for testing & verification purposes only. In a "real" app,
        /// you would never have an admin-only endpoint that isn't secured!! </summary> <param
        /// name="user"></param> <returns></returns>
        ...
        /// Preferences will be in the format: { preferences: {a:"b", c:"D"} }
        /// </param>
        /// <returns></returns>
