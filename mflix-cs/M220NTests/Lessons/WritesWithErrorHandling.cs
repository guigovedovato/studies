...
{
    /// <summary>
    /// In this lesson, we'll look at how we handle the common exceptions that might arrise when
    /// using the driver to write to MongoDB. We'll look at a 2 different types errors and how to
    /// handle them gracefully in your code. This way, we can ensure your applicaiton is resilient
    /// to issues that occur in concurrent and distributed systems.
    /// </summary>
