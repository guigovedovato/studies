...
{
    /// <summary>
    /// This Test Class shows the code used in the Basic Deletes lesson. /// In this lesson, we'll
    /// look at 3 ways to delete one or more documents from MongoDB. The methods are nearly
    /// identical to the methods we explored in the Updates lesson: the driver provides synchronous
    /// and asynchronous versions of the DeleteOne, DeleteMany, and FindOneAndDelete methods.
    /// </summary>
    public class BasicDeletes
    {
        ...
        /// <summary>
        /// Intentionally *not* async becasue we want to make sure the data is in MongoDB before
        /// runnning our tests!
        /// </summary>
